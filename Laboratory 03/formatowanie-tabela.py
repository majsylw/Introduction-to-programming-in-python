"""
Napisz program wypisujący na ekranie tabelę przedrostków SI
zawierającą w kolejnych kolumnach symbol, nazwę, wykładnik mnożnika oraz mnożnik od femto- do peta-.
"""
